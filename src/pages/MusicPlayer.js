...
const MusicPlayer = () => {
	return (
		...
		>
			<Banner>
				<motion.h2 variants={textFade}>Chillhop Music Player</motion.h2>
			...
			<Concept variants={wrapAnimation}>
				...
				<motion.div className="concept-text" variants={contentAnimation}>
					<motion.p>
						The inspiration for this fun project came from one of my favourite
						content creators on YouTube (DevEd) where I watched him build his
						own music app. This application gives me a playlist of open access
						music, uninterrupted by advertisements, which allows for a more
						convenient listening experience as an end user, while discovering
						new artists that I wouldn't normally find on big music streaming
						platforms.
					</motion.p>
				</motion.div>
			...
			<Development variants={wrapAnimation}>
				...
				<motion.div className="development-text" variants={contentAnimation}>
					<motion.p>
						This project has been built using React hooks, SASS and Styled
						components. The application features a library allowing users to
						select which song they would like to play and also includes play,
						pause and skip functionality.
					</motion.p>
					<motion.p>
						Each track has its own colours which change the background
						dynamically as you skip through songs.
					</motion.p>
					<motion.p>
