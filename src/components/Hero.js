	...
	return (
		<HeroWrapper id="home">
			<Description>
				<motion.div>
					<Hide>
						<motion.h1 variants={titleAnimation}>Ioan Tranole</motion.h1>
					</Hide>
					<Hide>
						<motion.h2 variants={titleAnimation}>Web Development /</motion.h2>
					</Hide>
					<Hide>
						<motion.h2 variants={titleAnimation}>UI Design</motion.h2>
					</Hide>
				</motion.div>
			...
			<Portfolio variants={portfolioAnimation} initial="hidden" animate="show">
